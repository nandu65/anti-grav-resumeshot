...
export const TEMPLATE_META: Record<TemplateId, { style: ResumePrefs["style"]; columns: 1 | 2; photoFriendly: boolean }> = {
  ...
  "monogram-blue-frame":   { style: "modern",    columns: 1, photoFriendly: false },
  "emerald-timeline":      { style: "modern",    columns: 1, photoFriendly: false },
  "hexagon-editorial":     { style: "executive", columns: 2, photoFriendly: false },
  "slate-node-timeline":   { style: "executive", columns: 1, photoFriendly: false },
  "centered-dual-column":  { style: "modern",    columns: 2, photoFriendly: false },
  "teal-duo-banner":       { style: "executive", columns: 1, photoFriendly: false },
  "taupe-header-split":    { style: "executive", columns: 1, photoFriendly: false },
