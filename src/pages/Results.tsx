...
import { downloadCoverLetterPdf } from "@/lib/pdfExport";
import { downloadResumePdfFromData, downloadResumeDocxFromData, downloadResumeTxtFromData, downloadResumeMarkdownFromData, TemplateId, ResumePreview, normalizeResumeSkills } from "@/lib/resumeTemplates";
            ...
            {!canDownload ? (
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-56">
                  ...
                  {proOnly && <DropdownMenuItem onClick={() => downloadResumeTxtFromData(buildResumeDataFromOptimization(opt))}><FileText className="h-4 w-4 mr-2" /> Plain text (ATS-safe)</DropdownMenuItem>}
                  {proOnly && <DropdownMenuItem onClick={() => downloadResumeMarkdownFromData(buildResumeDataFromOptimization(opt))}><Code2 className="h-4 w-4 mr-2" /> Markdown</DropdownMenuItem>}
                  {!proOnly && (
